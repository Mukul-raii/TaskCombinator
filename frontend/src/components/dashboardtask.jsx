...
export function DashboardCards({ task, teamId, user, cardUpdate, setUpdate }) {
    const { taskName, taskDescription, taskDueDate, taskPriority, taskStatus, assignTo, teamName, _id: taskID } = task
    ...
    }, [newStatus, taskStatus, teamId, assignTo, isUpdatedByClick])
